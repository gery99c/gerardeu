...
import { 
  FaHeart, FaShare, FaArrowUp, FaArrowDown, FaHome, FaSearch, 
...
function App() {
  ...
  // Estados para menú y búsqueda en móvil
  ...
  return (
    ...
    >
      ...
      {/* CONTENIDO PRINCIPAL (con padding superior para compensar la navbar fija) */}
